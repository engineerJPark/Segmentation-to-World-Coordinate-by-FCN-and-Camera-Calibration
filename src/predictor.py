...
class predictor():
  ...
  def predict_seg(self, image, depth):
    ...
    # stucked in the dimension
    image_np_class0 = np.copy(image_np)
    image_np_class0[test_image_channel_idx_stack != 0] = 0 
    image_np_class0 = image_np_class0.transpose(1,2,0)
    depth_np_class0 = np.copy(depth)
    depth_np_class0[test_image_channel_idx.detach().numpy() != 0] = 0
    image_np_class0 = np.asarray(image_np_class0, order='C')
    depth_np_class0 = np.asarray(depth_np_class0, order='C')
    image_o3d_class0 = o3d.geometry.Image(image_np_class0) # astype(np.uint8)
    depth_o3d_class0 = o3d.geometry.Image(depth_np_class0)

    # print(image_np_class0.shape)
    # print(depth_np_class0.shape)
    ...
    rgbd_out_class0 = rgbd_image_class0.create_from_color_and_depth(image_o3d_class0, depth_o3d_class0, convert_rgb_to_intensity=False)
    ...
    return test_image_mask, (rgbd_out_class0, rgbd_out_class1, rgbd_out_class2, rgbd_out_class3) # RGBDImage
